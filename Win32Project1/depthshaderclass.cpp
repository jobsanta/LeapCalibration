...
bool DepthShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../Win32Project1/depth.vs", L"../Win32Project1/depth.ps");
	if(!result)
	{
		return false;
	}
...
bool DepthShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, int indexOffset, int vertexOffset, XMMATRIX worldMatrix, XMMATRIX viewMatrix,
	XMMATRIX projectionMatrix, XMFLOAT3 cameraDistance)
{
	bool result;


	// Set the shader parameters that it will use for rendering.
	result = SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, cameraDistance);
	if(!result)
	{
		return false;
	}
...
bool DepthShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, XMFLOAT3 cameraDistance)
{
	HRESULT result;
...
void DepthShaderClass::RenderShader(ID3D11DeviceContext* deviceContext, int indexCount, int indexOffset, int vertexOffset)
{
